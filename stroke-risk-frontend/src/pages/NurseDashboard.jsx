            ...
            <div key={patient.id} className="horizontal-card">
              ...
              {expandedId === patient.id && (
                <div className="card-expanded-info">
                  ...
                  <p><strong>Hemoglobin:</strong> {patient.haemoglobin}</p>
                  <p><strong>PCV:</strong> {patient.pcv}</p>
        ...
        <div className="main-content">
          ...
          <form onSubmit={handleSubmit} className="patient-form">
            ...
            <div className="input-group">
              ...
              <input type="text" name="haemoglobin" placeholder="Hemoglobin" value={patientData.haemoglobin} onChange={handleChange} />
            </div>
            <div className="input-group">
              <input type="text" name="pcv" placeholder="PCV" value={patientData.pcv} onChange={handleChange} />
